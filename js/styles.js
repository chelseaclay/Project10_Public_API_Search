...
$("form").submit(function(evt){
  ...
  if (userSearch.val() === "") {
    ...
    var contentDiv = '<div id="content"><p>' + errorMessage + '</p></div>';
    ...
    function spotifyArtistCallback(data) {
      ...
      function lightboxContent() {
        ...
        function spotifyAlbumCallback(albumData) {
          ...
          lightboxAlbum += '<img class="album-art" src="' + albumData.images[1].url + '">';
      ...
      function iTunesCallback(data) {
        ...
        function lightboxContent(i) {
          ...
          lightboxMovie += '<div class="movie-info">';
            ...
            lightboxMovie += '<p class="movie-year">' + movieArray[0].results[i].releaseDate + '</p>';
